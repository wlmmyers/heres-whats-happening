...
export const ImageAnalysisSchema = z.object({
  acceptable: z
    .boolean()
    .describe('True only if this is a real photo of the named performer, suitable for a poster.'),
  reason: z
    .string()
    .describe(
      'If not acceptable, why — used to refine the next image search. If acceptable, a short note.',
    ),
  dominantColors: z
    .array(z.string())
    .describe("3-5 dominant colors of the photo as hex strings, e.g. '#1a2b3c'."),
});
