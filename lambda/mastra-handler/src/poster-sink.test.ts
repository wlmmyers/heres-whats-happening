...
const req = { userId: UID, performer: "Khruangbin", venue: "The Fillmore", date: "2026-08-15", force: false };
...
describe("posterKeyBase", () => {
  ...
  it("slugs spaces and punctuation", () => {
    expect(posterKeyBase({ ...req, performer: "Sigur Rós!", venue: "9:30 Club", date: "2026-09-01" })).toMatch(
      /\/sigur-ros\/9-30-club-2026-09-01-[0-9a-f]{10}$/,
    );
  });
